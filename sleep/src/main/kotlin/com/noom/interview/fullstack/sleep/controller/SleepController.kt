...
class SleepController(
    ...
    private fun toNewSleepLog(request: CreateSleepLogRequest) =
        NewSleepLog(
    ...
    private fun toSleepLogResponse(sleepLog: SleepLog) =
        SleepLogResponse(
    ...
    private fun toSleepStatsResponse(stats: SleepStats) =
        SleepStatsResponse(
